"""Publish the SG Forester glove box shelf to Thingiverse via the developer API.
...
CATEGORY = 'Automotive'
TAGS = ['subaru', 'forester', 'sg', 'fxt', 'glove_box', 'organizer',
        'shelf', 'interior', 'asa', 'automotive', 'car_mod']

FILES = [
    'models/stl/glove_box_shelf.stl',
    'models/3mf/shelf_ASA.3mf',
    'models/cad/gloveBoxShelf_v5.stp',
    'models/cad/gloveBoxShelf_v5.SLDPRT',
]
IMAGES = [  # first upload becomes the cover
    'gallery/shelf_installed.jpg',
]
